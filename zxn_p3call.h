...
#define zxn_ide_window_linein(lowaddr, bsize, nchars)		\
    zxn_p3call(zxn_p3cont_e, ZXN_IDE_WINDOW_LINEIN,		\
...
#define zxn_ide_window_string(lowaddr, nchars)		\
    zxn_p3call(zxn_p3cont_null, ZXN_IDE_WINDOW_STRING,	\
...
#define zxn_ide_integer_var(v,rw,val)				\
    zxn_p3call(zxn_p3cont_de_err, ZXN_IDE_INTEGER_VAR,		\
...
#define zxn_ide_mode_set(mode,submode)			\
    zxn_p3call(zxn_p3cont_generic, ZXN_IDE_MODE,	\
